...
<!--       <a href="#!" class="brand-logo cyan-text header-menu">Logo</a> -->
	...
	<span class="thin  login-text-center"> Wanna A Tour?</span>
	<span class=" thin  login-text-center" >Login for more functions.</span>
	<br>
	<div class="row">
		...
		<form class="card-content" action="login" method="post">
			...
			<div class="col s0 m2">&nbsp;</div>
				<div class="input-field col s12 m8">
					<input  name="username" type="text" class=""> <label for="">Username</label>
				</div>
			</div>
			<div class="row">
				<div class="col s0 m2">&nbsp;</div>
				<div class="input-field col s12 m8">
					<input  name="password"type="password" class=""> <label
						for="">Password</label>
				</div>
			</div>
			<center>
			  <button class="btn cyan waves-effect waves-light" type="submit"  required="" name="login">Submit
			  </button>
			</center>
		</form>
	</div>
