...
<!--       <a href="#!" class="brand-logo cyan-text header-menu">Logo</a> -->
	...
	<span class="thin  login-text-center">For easy transport.</span>
	<br>
	<div class="row">
		...
		<form class="card-content" action="login" method="post">
			<div class="row">
				...
				<div class="input-field col s12 m12 l6">
					<input  name="confirm"type="password" class=""> <label
						for="">Confirm</label>
				</div>
			</div>
			<center>
			  <button class="btn cyan waves-effect waves-light" type="submit"  required="" name="regist">Submit
			  </button>
			</center>
		</form>
	</div>
