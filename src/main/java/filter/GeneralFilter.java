...
public class GeneralFilter implements Filter {
	...
	private void membershipJudge(FilterChain chain) throws ServletException, IOException {
	...
	private void administrationJudge(FilterChain chain) throws ServletException, IOException {
